...
export default function ProfileClient({ profile: initial }: { profile: Profile }) {
  ...
  return <div className="mx-auto max-w-5xl space-y-6">
    ...
    <form onSubmit={changePassword} className="rounded-3xl border border-amber-700/50 bg-amber-950/10 p-6 sm:p-8">
      <h2 className="text-lg font-black text-slate-100">Segurança</h2><p className="mt-1 text-xs text-slate-400">Altere sua senha de acesso sem sair do painel. Informe a senha atual; ao confirmar, todas as suas sessões serão encerradas.</p>
